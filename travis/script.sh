...
if [ "$GLTEST" = "py2_test" ] || [ "$GLTEST" = "py3_test" ]; then
  ...
  declare -a capabilities=(
    ...
    "export SELENIUM_BROWSER_CAPABILITIES='{\"browserName\": \"Safari\", \"platformName\":\"iOS\", \"platformVersion\": \"13.0\", \"deviceName\": \"iPhone 11 Simulator\", \"deviceOrientation\": \"portrait\", \"maxDuration\":\"7200\", \"commandTimeout\":\"600\", \"idleTimeout\":\"270\"}'"
  )
